...
&nbsp;
  ...
  Memory.prototype.add = <span class="fstat-no" title="function not covered" >function(geojson, callback){</span>
...
<span class="cstat-no" title="statement not covered" >        this.data[geojson.features[i].id] = geojson.features[i];</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      this.data[geojson.id] = geojson;</span>
    }
...
&nbsp;
  ...
  Memory.prototype.remove = <span class="fstat-no" title="function not covered" >function(id, callback){</span>
<span class="cstat-no" title="statement not covered" >    delete this.data[id];</span>
...
&nbsp;
  ...
  Memory.prototype.get = function(id, callback){
    <span class="missing-if-branch" title="else path not taken"" >E</span>if ( callback ) callback( null, this.data[id] );
  };
&nbsp;
  Memory.prototype.update = <span class="fstat-no" title="function not covered" >function(geojson, callback){</span>
<span class="cstat-no" title="statement not covered" >    this.data[geojson.id] = geojson;</span>
...
&nbsp;
  Memory.prototype.serialize = function(callback){
    ...
    <span class="missing-if-branch" title="else path not taken"" >E</span>if ( callback ) callback( null, data );
  };
&nbsp;
